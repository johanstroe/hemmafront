    ...
    <Sheet open={open} onOpenChange={(v) => !v && onClose()}>
      <SheetContent side="bottom" className="rounded-t-3xl">
        ...
        <div className="py-8 flex flex-col items-center gap-4">
          <div className="font-mono text-4xl font-bold tracking-[0.2em] bg-secondary rounded-2xl px-8 py-6">
            {household.invite_code}
          </div>
          <Button onClick={copy} variant="outline" size="lg" className="rounded-full gap-2">
